...
def create_buffer_from_one_demo_offline(action_type = 'speed', demo_name = "EP0"):
	...
	# client_interface_.py needs "buffer_name" to load buffer
	if demo_name == "EP0":
		buffer_name = "EP0_human_expert_7"
		max_size = int(13300)
		# max_size = int(20431)  "EP0_human_expert_0"
	elif demo_name == "CHN":
		buffer_name = "CHN_human_expert_3"
		max_size = int(206404)
	...
	demonstration_name = f"{demo_name}_{action_type}_demonstration_007"
...
create_buffer_from_all_demo_offline(action_type = "speed", demo_name = "EP0")
